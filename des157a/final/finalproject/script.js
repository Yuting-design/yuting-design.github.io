(function () {
    ...
    document.getElementById("volumeUp").addEventListener("click",function(){
        if(sdvolume<1){
            sdvolume = sdvolume + 0.1;
        switchSound.volume = sdvolume;
        startSound.volume = sdvolume;
        winSound.volume = sdvolume;
        buttonSound.volume = sdvolume;
        bgm.volume = sdvolume*0.3;
        }else{
            sdvolume = 1;
        }
